...
import com.zhaksylyk.accounts.dto.AccountsMsgDto;
...
import com.zhaksylyk.accounts.exception.CustomerAlreadyExistsException;
...
public class AccountsServiceImpl implements IAccountsService {
    ...
    public void createAccount(CustomerDto customerDto) {
        ...
        if(optionalCustomer.isPresent()){
            throw new CustomerAlreadyExistsException("Customer with the given movile number already exists " + customerDto.getMobileNumber());
        }
